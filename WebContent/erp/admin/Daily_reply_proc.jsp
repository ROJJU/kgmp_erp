...
d_report.setRef_seq(Integer.parseInt(mr.getParameter("ref_seq")));
d_report.setStep(Integer.parseInt(mr.getParameter("step")));
d_report.setDepth(Integer.parseInt(mr.getParameter("depth")));
d_report.setId(mr.getParameter("id"));

String check = report_DAO.insertPostsReply(d_report);

if(check.equals("true")){
	%>
			alert('일간업무 등록에 성공하셨습니다.');
			location.href="adminWork.jsp";
	<%
}else{
	%>
