...
pageContext.setAttribute("c", CustomerDAO.getComment(c_comment_seq));
...
<body>
	<hr>
	<form action="Comment_modify_proc.jsp" method="post" name="c_comment_add">
		...
		<textarea rows="10" cols="50" name="c_comment">${c.c_comment}</textarea><br>
		...
		<input type="hidden" value="${c.c_comment_seq}" name="c_comment_seq">
	</form>
</body>
</html>